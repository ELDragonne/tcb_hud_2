...
HUD.HealthColor = Color(67, 192, 43, 255)
HUD.ArmorColor 	= Color(192, 43, 96, 255)
...
local function Base()
	...
	-- Background
	draw.RoundedBox(4, HUD.PosX-1, HUD.PosY-1, HUD.Width+2, HUD.Height+2, Color(25,25,25,255))
	draw.RoundedBox(4, HUD.PosX, HUD.PosY, HUD.Width, HUD.Height, Color(25,25,25,255))

	-- Sections
	draw.RoundedBoxEx(4, HUD.PosX, HUD.BPosY, HUD.Width, HUD.BHeight, Color(40,40,40,255), false, false, true, true)
	draw.RoundedBoxEx(4, HUD.PosX + HUD.Width - 50, HUD.PosY, 50, HUD.HHeight, Color(25,25,25,255), false, true, false, false)
	draw.RoundedBoxEx(4, HUD.PosX, HUD.PosY, 75, HUD.HHeight, Color(60,60,60,255), true, false, false, false)

	-- Borders
	draw.RoundedBox(0, HUD.PosX, HUD.BPosY-4, HUD.Width, 2, Color(0,221,221,200))
	draw.RoundedBox(0, HUD.PosX, HUD.BPosY-2, HUD.Width, 2, Color(0,177,177,160))

	draw.RoundedBox(0, HUD.PosX + HUD.Width - 50 - 4, HUD.PosY, 2, HUD.HHeight, Color(0,221,221,200))
	draw.RoundedBox(0, HUD.PosX + HUD.Width - 50 - 2, HUD.PosY, 2, HUD.HHeight, Color(0,177,177,160))

	draw.RoundedBox(0, HUD.PosX + 75 + 2, HUD.PosY, 2, HUD.HHeight, Color(0,221,221,200))
	draw.RoundedBox(0, HUD.PosX + 75, HUD.PosY, 2, HUD.HHeight, Color(0,177,177,160))
...
local function Armor()
	...
	-- Title
	draw.DrawText("Protection", "TCB_BebasNeue_1", HUD.PosX + 10 + 1, HUD.BPosY2 + 6 + 1, Color(0, 0, 0, 255), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
	draw.DrawText("Protection", "TCB_BebasNeue_1", HUD.PosX + 10, HUD.BPosY2 + 6, Color(255, 255, 255, 255), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
...
local function PlayerInfo()
	...
	-- Job
	draw.DrawText("Metier: ", "TCB_BebasNeue_1", HUD.PosX + 85 + 1, HUD.PosY + 18 * 1 + 2.5 * 2 + 1, Color(0, 0, 0, 255), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
	draw.DrawText("Metier: ", "TCB_BebasNeue_1", HUD.PosX + 85, HUD.PosY + 18 * 1 + 2.5 * 2, Color(192, 57, 43, 255), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
...
local function DrawVoiceChat()
	if LocalPlayer().DRPIsTalking then
		...
		surface.SetDrawColor(Color(0,221,221,240))
...
usermessage.Hook("GotArrested", function(msg)
	...
	Arrested = function()
		...
		draw.DrawNonParsedText(DarkRP.getPhrase("Vous êtes arrêter", math.ceil(ArrestedUntil - (CurTime() - StartArrested))), "DarkRPHUD1", ArrestedX, ArrestedY, Color(255, 255, 255, 255), 1)
